...
export const siteConfig = {
  name: "Strumen - Гран-Система-С - Приборы учета энергоресурсов в Беларуси",
  description:
    "ГРАН-СИСТЕМА-С – ведущий разработчик и производитель приборов учета и потребления энергоресурсов в Республике Беларусь. Решения для промышленных и бытовых объектов.",
  benefits: [
    {
